      ...
      post: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('post',
                                     ...
                                     'anonymous-feedback-board.compact line 41 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      takeDown: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('takeDown',
                                     'argument 1 (as invoked from Typescript)',
                                     'anonymous-feedback-board.compact line 48 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
  ...
  _localSecretKey_0(context, partialProofData) {
    ...
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('localSecretKey',
                                 'return value',
                                 'anonymous-feedback-board.compact line 39 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
                                    ...
                                    __compactRuntime.convertFieldToBytes(32,
                                                                         _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                                                   ...
                                                                                                                                   [
                                                                                                                                    ...
                                                                                                                                    { popeq: { cached: true,
                                                                                                                                               result: undefined } }]).value),
                                                                         'anonymous-feedback-board.compact line 43 char 48'));
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                            ...
                                                            __compactRuntime.convertFieldToBytes(32,
                                                                                                 _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                                                                           ...
                                                                                                                                                           [
                                                                                                                                                            ...
                                                                                                                                                            { popeq: { cached: true,
                                                                                                                                                                       result: undefined } }]).value),
                                                                                                 'anonymous-feedback-board.compact line 50 char 47'))),
  ...
  publicKey: (...args_0) => {
    ...
    if (!(sk_0.buffer instanceof ArrayBuffer && sk_0.BYTES_PER_ELEMENT === 1 && sk_0.length === 32)) {
      __compactRuntime.typeError('publicKey',
                                 'argument 1',
                                 'anonymous-feedback-board.compact line 58 char 1',
                                 'Bytes<32>',
                                 sk_0)
    }
